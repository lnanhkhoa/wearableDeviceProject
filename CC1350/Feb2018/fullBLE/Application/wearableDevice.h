...
extern void wearableDevice_SetupSleepMode(void);

extern void wearableDevice_BigTime(void);

extern void wearableDevice_stateBLE(bool stateBLE);

extern void wearableDevice_updateTime(uint8_t *pointerDateTime);

extern void wearableDevice_updateConfigProfile(uint8_t *newconfigprofile);
