...
/////////////////////////////////////////////////Modified - RED DATA////////////////////////////////////////////////////////
/////////////////////////////////////////////////Modified - IR DATA/////////////////////////////////////////////////////////
long hr3_get_GR_data(){
  uint8_t dataLedGreenArray[3] = {0, 0, 0};
  I2c_ReadRegister(AFE_ADDR,0x2C, dataLedGreenArray,3);
  long dataLongLed1 = 0;
  //show_bit_data(0);
...
long hr3_get_RED_data(){
  uint8_t dataLedRedArray[3] = {0, 0 , 0};
  I2c_ReadRegister(AFE_ADDR,0x2C, dataLedRedArray,3);
  long dataLongLed1 = 0;
  //show_bit_data(0);
...
long hr3_get_IR_data(){
  uint8_t dataIRRedArray[3] = {0, 0, 0};
  I2c_ReadRegister(AFE_ADDR,0x2C, dataIRRedArray,3);
  long dataLongLed1 = 0;
  //show_bit_data(0);
...
int8_t hr3_set_settings( sw_reset_t sw_reset, diag_mode_t diag_mode, susp_count_t susp_counter, reg_read_t reg_read )
{
  ...
  I2c_WriteRegister(AFE_ADDR, reg_address, temp, 3);
...
int8_t hr3_set_led2_start_end( uint16_t start, uint16_t end )
{
  ...
  I2c_WriteRegister(AFE_ADDR, reg_st, temp_st, 3);

  temp_end[1] = end >> 8;
  temp_end[2] = (uint8_t)end;

  I2c_WriteRegister(AFE_ADDR, reg_end, temp_end, 3);
...
int8_t hr3_set_prpct_count( uint16_t count )
{
  ...
  I2c_WriteRegister(AFE_ADDR, reg, temp, 3);

  return 0;

}

int8_t hr3_set_timer_and_average_num( bool enable, int8_t av_num )
{
  uint8_t reg = TIM_NUMAV;
  uint8_t temp[3] = { 0 };

  if( av_num > 15 || av_num <0) return (-1);
